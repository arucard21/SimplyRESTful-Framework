...
import simplyrestful.api.framework.core.api.webresource.DefaultCollectionGetPreferHAL;
...
public class TestWebResourcePreferHAL implements DefaultCollectionGetPreferHAL<TestResource>{
    @Override
