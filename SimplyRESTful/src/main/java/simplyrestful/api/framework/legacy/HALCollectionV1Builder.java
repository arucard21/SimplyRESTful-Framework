...
public class HALCollectionV1Builder<T extends HALResource> {
	public static final String ERROR_MORE_RESOURCES_PROVIDED_THAN_ALLOWED = "More resources were provided than the max page size. You may want to try using HALCollectionBuilder.fromFullList.";
	...
	protected long page = Long.valueOf(LegacyCollectionGet.V1_QUERY_PARAM_PAGE_DEFAULT);
	protected long maxPageSize = Long.valueOf(DefaultCollectionGet.QUERY_PARAM_PAGE_SIZE_DEFAULT);
	protected boolean compact = Boolean.valueOf(LegacyCollectionGet.V1_QUERY_PARAM_COMPACT_DEFAULT);
	...
	protected HALLink createHALLinkFromURIWithModifiedPageNumber(URI requestURI, int pageNumber){
		...
		hrefBuilder.replaceQueryParam(LegacyCollectionGet.V1_QUERY_PARAM_PAGE, pageNumber);
